...
Page({
  ...
  drawSpot (step) {
    const context = my.createCanvasContext('canvasSpot', this)
    ...
    context.rotate(-(this.data.angle * step) * Math.PI / 180);
  ...
  drawCircle: function (step) {
    const context = my.createCanvasContext('canvasProgress', this)
